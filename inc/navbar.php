        ...
        <div class="row hidden-xs"><!-- Menu -->
            <div class="col-xs-4">
                <figure class="logo-navbar2"></figure>
                   <p class="text-navbar tittles-pages-logo">Pedidos Web Platillos</p>
            </div>
            <div class="col-xs-8">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en Pedidos Web Platillos</h4>
                </div>
